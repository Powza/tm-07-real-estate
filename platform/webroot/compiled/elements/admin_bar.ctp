                            ...
                            <a tabindex="-1" href="#">All Portals</a>
                                ...
                                <?php
                                    foreach($agentPortals as $agentPortal) {
                                    	$portalUrl = $agentPortal['portal_url'];
                                    	function addHttp($portalUrl, $scheme = 'http://') { 
										    return parse_url($portalUrl, PHP_URL_SCHEME) === null ? 
										            $scheme . $portalUrl : $portalUrl; 
										}
                                        echo '<li><a href="'.addHttp($portalUrl).'">'.$agentPortal['name'].'</a></li>';
                                    }
                                ?>
                            </ul>
                        </li>
