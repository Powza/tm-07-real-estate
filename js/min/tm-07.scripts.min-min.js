...
function i(){if($(".listings_view .royalSlider").length){var e=$(".listings_view .royalSlider .rsNavSelected img").attr("src");$(".banner.section__background").css("background-image","url("+e+")")}}
// Sidebar Scroll List Box
function t(){$(".sidebar .sidebar__list-scroll").each(function(e){$(this).attr("id","list"+e),$(".sidebar .sidebar__list-scroll#list"+e+" ul").html($(".sidebar .sidebar__list-scroll#list"+e+" ul li").sort(function(){return Math.random()-.5}))}),$(".sidebar .sidebar__list-scroll .list-slider ul").each(function(e,i){var t="carousel"+e;this.id=t,$(this).slick({vertical:!0,verticalSwiping:!0,slidesToShow:6,slidesToScroll:6,prevArrow:'<button type="button" class="slick-prev btn btn__light__outline"><i class="fa fa-angle-up"></i></button>',nextArrow:'<button type="button" class="slick-next btn btn__light__outline"><i class="fa fa-angle-down"></i></button>',appendArrows:$("<div></div>").addClass("section__slider-arrows").appendTo(".sidebar__list-scroll#list"+e+" h4")})})}
// Sidebar Multilevel List Box
function s(){$(".sidebar__multilevel-list").each(function(e){$(this).attr("id","multilevel_"+e),$("ul:first",this).addClass("sm sm-vertical-list").smartmenus()})}
// Homepage Property Slider
function r(){$(".property-slider:not(.sidebar .property-slider)").each(function(e){$(this).attr("id","slide_"+e)}),$(".property-slider:not(.sidebar .property-slider) .slider-wrap").each(function(e,i){var t="carousel_"+e;this.id=t,$(this).slick({slidesToShow:4,slidesToScroll:4,rows:2,prevArrow:'<button type="button" class="slick-prev btn btn__primary__outline"><i class="fa fa-angle-left"></i> Prev</button>',nextArrow:'<button type="button" class="slick-next btn btn__primary__outline">Next <i class="fa fa-angle-right"></i></button>',appendArrows:$("<div></div>").addClass("section__slider-arrows").appendTo($(this).parent()),responsive:[{breakpoint:1680,settings:{slidesToShow:3,slidesToScroll:3}},{breakpoint:992,settings:{slidesToShow:2,slidesToScroll:2}},{breakpoint:767,settings:{slidesToShow:1,slidesToScroll:1}}]})})}
...
function l(){$(".agent-slider .slider-wrap").html($(".agent-slider .slider-wrap .agent").sort(function(){return Math.random()-.5})),$(".agent-slider .agent-img").Lazy({scrollDirection:"vertical"}),$(".agent-slider .slider-wrap").slick({slidesToShow:5,slidesToScroll:5,prevArrow:'<button type="button" class="slick-prev btn btn__primary__outline"><i class="fa fa-angle-left"></i> Prev</button>',nextArrow:'<button type="button" class="slick-next btn btn__primary__outline">Next <i class="fa fa-angle-right"></i></button>',appendArrows:$("<div></div>").addClass("section__slider-arrows").appendTo(".agent-slider"),responsive:[{breakpoint:1680,settings:{slidesToShow:4,slidesToScroll:4}},{breakpoint:1440,settings:{slidesToShow:3,slidesToScroll:3}},{breakpoint:1100,settings:{slidesToShow:3,slidesToScroll:3}},{breakpoint:992,settings:{slidesToShow:2,slidesToScroll:2}},{breakpoint:767,settings:{slidesToShow:1,slidesToScroll:1}}]})}
// RoyalSlider Fullscreen Hide Header
function n(){if($(".listings_view .royalSlider").length){var e=$(".royalSlider").data("royalSlider");e.ev.on("rsEnterFullscreen",function(){$(".header").hide()}),e.ev.on("rsExitFullscreen",function(){$(".header").show()})}}
// Navbar Scroll
function a(){var e=document.querySelector(".header .header__meta"),i;window.location.hash&&e.classList.add("headroom--unpinned"),new Headroom(e,{tolerance:{down:10,up:20},offset:$(".admin-navbar").outerHeight()+$(".header").outerHeight()}).init()}
// Header padding
...
// Hero Video
function _(){var e=".hero__video";$(e).YTPlayer({videoURL:$(e).data("video-url"),containment:e,loop:!0,autoPlay:!0,showControls:!1,abundance:0,stopMovieOnBlur:!1,playOnlyIfVisible:!0,onScreenPercentage:100})}
// Check if media type is defind and default if empty
function m(){var e=$.trim($(".hero__media").data("media-type"));"video"==e?($(".hero__media__slider").remove(),$(".hero__media__video").show(),_()):($(".hero__media__video").remove(),$(".hero__media__slider").show(),p())}e(),
// Lazyload
$(".lazy").Lazy({scrollDirection:"vertical",threshold:0}),i(),t(),s(),r(),o(),l(),n(),
// svg4everybody
svg4everybody(),
// SmartMenus
...
// Enable tooltips
$('[data-toggle="tooltip"]').tooltip({delay:{show:500,hide:500}}),u(),m()});