...
function l(){function e(){var e=$(this).scrollTop();
// Make sure they scroll more than delta
Math.abs(i-e)<=s||(i<e&&r<e?
// Scroll Down
$(".header__meta").css({opacity:"0",transform:"translateY(-100%)"}):
// Scroll Up
e+$(window).height()<$(document).height()&&$(".header__meta").css({opacity:"1",transform:"translateY(0)"}),i=e)}var t,i=0,s=46,r=$("header").outerHeight();$(window).scroll(function(e){t=!0}),setInterval(function(){t&&(e(),t=!1)},0)}
// Header padding
...
// Lazyload
$(".lazy").Lazy({scrollDirection:"vertical",threshold:0}),e(),t(),i(),s(),r(),o(),
// svg4everybody
svg4everybody(),
// SmartMenus
...
$("#qs_form .multi-select.placeholder").remove(),$("#qs_form .multi-select").show(),$("#qs_form .multi-select").multipleSelect({minimumCountSelected:2,placeholder:$(this).data("placeholder")}),
// Scroll Navigation Menu
$(window).scroll(function(){var e=$(this).scrollTop(),t=$(".start-scroll").position();e>$("header").outerHeight()?$(".header__meta").addClass("fixed"):$(".header__meta").removeClass("fixed")}),l(),$(window).resize(function(){a()}),a(),n(),
// Enable tooltips
