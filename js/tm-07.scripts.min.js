$(function() {
  ...
  function propertySlider() {
    ...
    $(".property-slider:not(.sidebar .property-slider) .slider-wrap").each(function(i) {
  ...
  // SmartMenus
  $(".header__meta #main_navigation, .mobile-menu #main_navigation").smartmenus();
  ...
  function headerHeadroom() {
    ...
    var headroom = new Headroom(header, {
      ...
      offset: $(".admin-navbar").outerHeight() + $(".header__company").outerHeight()
    });
    headroom.init();
  }
  headerHeadroom();
  ...
  function headerCalculateHeroPadding() {
    ...
    var heroCalloutHeight = $(".hero__callout").outerHeight();
